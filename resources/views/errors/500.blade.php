...
<head>
    ...
    <title>500 - Kesalahan Server | DLHK Jawa Tengah</title>
...
<body
    ...
    <main class="flex-1 flex flex-col items-center justify-center px-6 py-12">
        <div class="relative w-full max-w-4xl text-center">
            ...
            <div
                class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 md:w-96 md:h-96 bg-red-500/5 dark:bg-red-500/10 organic-shape -z-10 blur-2xl">
            </div>
            ...
            <div class="relative inline-block mb-8">
                <!-- Warning Icon -->
                <span
                    class="absolute -top-8 left-1/2 -translate-x-1/2 material-icons text-6xl text-red-400/50 select-none">warning</span>

                <!-- Big 500 Number -->
                <h1
                    class="text-[100px] md:text-[160px] font-extrabold leading-none tracking-tighter text-red-500/10 dark:text-red-500/20 flex items-center justify-center select-none shake-animation">
                    5
                    <span class="inline-flex items-center justify-center mx-2 relative">
                        <div class="absolute w-24 h-24 md:w-32 md:h-32 rounded-full bg-red-500/20 pulse-ring"></div>
                        <div
                            class="w-20 h-20 md:w-28 md:h-28 rounded-full bg-gradient-to-br from-red-500 to-orange-600 flex items-center justify-center shadow-2xl shadow-red-500/30 relative z-10">
                            <span class="material-icons text-white text-4xl md:text-5xl">cloud_off</span>
                        </div>
                    </span>
                    0
                </h1>
                ...
                <div class="absolute -bottom-2 left-1/2 -translate-x-1/2">
                    <div class="h-1.5 w-32 mx-auto bg-gradient-to-r from-red-500 to-orange-500 rounded-full opacity-60">
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-4 max-w-xl mx-auto mt-8">
                ...
                <p class="text-base md:text-lg text-gray-600 dark:text-gray-400 font-medium leading-relaxed">
                    Maaf, terjadi kesalahan pada server kami. Tim teknis sedang bekerja untuk memperbaikinya. Silakan
        ...
        <div class="mt-16 opacity-60">
            <div class="flex flex-col items-center">
                <span class="material-icons text-5xl text-red-400">engineering</span>
                <p class="text-xs font-bold tracking-widest uppercase mt-3 text-secondary">Sedang Diperbaiki</p>
            </div>
        </div>
    </main>
    ...
    <footer class="w-full border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-6 py-6">
        <div class="mx-auto max-w-6xl flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-3 text-xs font-medium text-red-500">
