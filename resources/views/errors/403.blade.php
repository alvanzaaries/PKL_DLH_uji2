...
<head>
    ...
    <title>403 - Akses Ditolak | DLHK Jawa Tengah</title>
...
<body
    ...
    <main class="flex-1 flex flex-col items-center justify-center px-6 py-12">
        <div class="relative w-full max-w-4xl text-center">
            ...
            <div
                class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 md:w-96 md:h-96 bg-amber-500/5 dark:bg-amber-500/10 organic-shape -z-10 blur-2xl">
            </div>
            ...
            <div class="relative inline-block mb-8">
                <!-- Shield Icon -->
                <span
                    class="absolute -top-8 left-1/2 -translate-x-1/2 material-icons text-6xl text-amber-400/50 select-none">shield</span>

                <!-- Big 403 Number -->
                <h1
                    class="text-[100px] md:text-[160px] font-extrabold leading-none tracking-tighter text-amber-500/10 dark:text-amber-500/20 flex items-center justify-center select-none">
                    4
                    <span class="inline-flex items-center justify-center mx-2">
                        <div
                            class="w-20 h-20 md:w-28 md:h-28 rounded-full bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center shadow-2xl shadow-amber-500/30 lock-bounce">
                            <span class="material-icons text-white text-4xl md:text-5xl">lock</span>
                        </div>
                    </span>
                    3
                </h1>
                ...
                <div class="absolute -bottom-2 left-1/2 -translate-x-1/2">
                    <div
                        class="h-1.5 w-32 mx-auto bg-gradient-to-r from-amber-500 to-orange-500 rounded-full opacity-60">
                    </div>
                </div>
            </div>
        ...
        <div class="mt-16 opacity-50">
            <div class="flex flex-col items-center">
                <span class="material-icons text-5xl text-amber-500">security</span>
                <p class="text-xs font-bold tracking-widest uppercase mt-3 text-secondary">Area Terbatas</p>
            </div>
        </div>
    </main>
