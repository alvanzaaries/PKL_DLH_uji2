...
<head>
    ...
    <title>Tambah Industri Primer - SIIPPHH</title>
    ...
    <nav>
        <div class="nav-content">
            <div class="logo-area">
                ...
                <span class="logo-text">SIIPPHH</span>
            </div>
    ...
    <div class="container">
        ...
        <div class="form-card">
            <form action="{{ route('industri-primer.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="form-label">
                        Status Pelaporan <span class="required">*</span>
                    </label>
                    <select name="pelaporan" class="form-select" required>
                        <option value="">-- Pilih Status --</option>
                        <option value="Aktif" {{ old('pelaporan') == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                        <option value="Tidak Aktif" {{ old('pelaporan') == 'Tidak Aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                        <option value="Pending" {{ old('pelaporan') == 'Pending' ? 'selected' : '' }}>Pending</option>
                    </select>
                    @error('pelaporan')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
