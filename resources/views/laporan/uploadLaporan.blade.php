                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex gap-2">
                        <button type="button" id="btnExcelMode"
                            class="px-4 py-2 text-xs font-semibold bg-[#1A4030] text-white rounded-sm transition-all">
                    ...
                    <div id="manualSection" class="mb-6 hidden">
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <button type="button" id="btnAddRow"
                                class="px-3 py-1.5 text-xs font-semibold bg-[#1A4030] text-white rounded-sm hover:bg-[#2d5a47] transition-all">
    ...
    <script>
        ...
        function generateTableRow(config, rowNum) {
            ...
            config.fields.forEach(field => {
                ...
                let inputClass = 'w-full px-2 py-1.5 border border-gray-300 rounded text-sm focus:ring-1 focus:ring-[#1A4030] focus:border-[#1A4030]';
