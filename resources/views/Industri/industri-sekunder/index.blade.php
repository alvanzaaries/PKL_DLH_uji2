...
@section('content')
        ...
        <div class="page-header">
            <div class="page-header-main">
                <div class="page-header-left">
                    ...
                    <div>
                        <h1 class="page-title">Data Industri Sekunder (IPHHK)</h1>
        ...
        <div class="table-card">
            <div class="table-header">
                <h2 class="table-title"><i class="fas fa-table"></i>Daftar Perusahaan Industri Sekunder</h2>
...
@push('scripts')
    ...
    <script>
        function showDetail(item) {
            ...
            // Format jenis produksi dengan kapasitas masing-masing
    ...
    <script>
        ...
        function processImport() {
            ...
            // Send AJAX request
            fetch('{{ route("industri-sekunder.import") }}', {
                method: 'POST',
                body: formData,
                headers: {
        ...
        function exportToExcel() {
            const form = document.querySelector('form[action="{{ route('industri-sekunder.index') }}"]');
            const formData = new FormData(form);
            const params = new URLSearchParams(formData);
            
            window.location.href = '{{ route("industri-sekunder.export") }}?' + params.toString();
        }
    </script>
