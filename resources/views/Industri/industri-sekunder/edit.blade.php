        ...
        <form action="{{ route('industri-sekunder.update', $industriSekunder->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" name="total_nilai_investasi" class="form-input" placeholder="Masukkan total nilai investasi (Rp)" value="{{ old('total_nilai_investasi', $industriSekunder->total_nilai_investasi) }}" min="0">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="total_pegawai" class="form-input" placeholder="Jumlah pegawai" value="{{ old('total_pegawai', $industriSekunder->total_pegawai) }}" min="0">
