                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            value="{{ old('latitude', $perajin->industri->latitude) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            value="{{ old('longitude', $perajin->industri->longitude) }}"
                            onchange="updateMapFromInputs()"
                        >
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" class="form-select" required>
                            <option value="Aktif" {{ old('status', $perajin->industri->status) == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                            <option value="Tidak Aktif" {{ old('status', $perajin->industri->status) == 'Tidak Aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                        </select>
