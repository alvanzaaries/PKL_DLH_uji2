    ...
    <div class="form-card">
        <form action="{{ route('industri-primer.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama" class="form-input" placeholder="Contoh: PT. Kayu Lestari Indonesia" value="{{ old('nama') }}" required>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" name="total_nilai_investasi" class="form-input" placeholder="Masukkan total nilai investasi (Rp)" value="{{ old('total_nilai_investasi') }}" min="0">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="total_pegawai" class="form-input" placeholder="Jumlah pegawai" value="{{ old('total_pegawai') }}" min="0">
            ...
            <div class="form-group">
                ...
                <div class="file-upload-wrapper" onclick="document.getElementById('dokumenInput').click()">
                    ...
                    <div style="font-size: 14px; color: #475569;">Klik untuk pilih file PDF</div>
