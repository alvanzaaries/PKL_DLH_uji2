...
class IndustriPrimerExport
{
    ...
    public function export()
    {
        ...
        $sheet->setCellValue('A1', 'Data Industri Primer' . ($filterText ? ' berdasarkan ' . $filterText : ''));
        ...
        $filename = 'Data_Industri_Primer_' . date('Y-m-d_His') . '.xlsx';
